...
# -------------------------
# ESTILO DE BOTONES (CELESTE + TEXTO BLANCO)
# -------------------------
estilo = ttk.Style()
estilo.theme_use("clam")  # Necesario para aplicar colores personalizados

estilo.configure(
    "BotonCeleste.TButton",
    font=("Arial", 12),
    padding=10,
    foreground="white",        # Letra blanca
    background="#4DB8FF"       # Celeste
)

estilo.map(
    "BotonCeleste.TButton",
    background=[("active", "#1A8CFF")]  # Color cuando se presiona/hover
)
...
# BOTONES PRINCIPALES
# -------------------------
btn_reg_prod = ttk.Button(ventana, text="Registro de Productos", style="BotonCeleste.TButton",
                          command=abrir_registro_productos)
btn_reg_prod.pack(pady=10)

btn_reg_ventas = ttk.Button(ventana, text="Registro de Ventas", style="BotonCeleste.TButton",
                            command=abrir_registro_ventas)
btn_reg_ventas.pack(pady=10)

btn_reportes = ttk.Button(ventana, text="Reportes", style="BotonCeleste.TButton",
                          command=abrir_reportes)
btn_reportes.pack(pady=10)

btn_acerca = ttk.Button(ventana, text="Acerca de", style="BotonCeleste.TButton",
